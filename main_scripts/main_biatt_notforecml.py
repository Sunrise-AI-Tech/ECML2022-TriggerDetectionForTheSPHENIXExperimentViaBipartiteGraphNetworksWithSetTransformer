...
def parse_args():
    ...
    argparser.add_argument('--config', default='configs/mix_track_biatt.yaml')
    ...
    argparser.add_argument('--name', type=str, default=None,
            help="Run name")
    argparser.add_argument('--wandb', type=str, default='trigger-biatt-7layer', 
...
def do_epoch(data, model, epoch, optimizer=None, use_energy=False, use_momentum=False, use_radius=False):
    ...
    for batch in data:
        ...
        tracks, vtx, trig, momentum, radii = batch
