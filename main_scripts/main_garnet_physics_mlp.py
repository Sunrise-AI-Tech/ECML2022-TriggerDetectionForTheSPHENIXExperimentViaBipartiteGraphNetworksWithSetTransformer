...
def extract_hyperparameters(config):
    ...
    hp['model_physics_path'] = config['model_physics_path']
    hp['n_features/model_physics'] = config['model_physics']['n_features']
    hp['n_hidden/model_physics'] = config['model_physics']['n_hidden']
    hp['hidden_size/model_physics'] = config['model_physics']['hidden_size']
    hp['hidden_activation/model_physics'] = config['model_physics']['hidden_activation']
...
def train(data, model, model_physics, optimizer, epoch, output_dir, use_energy=False, use_momentum=False):
    train_info = do_epoch(data, model, epoch, optimizer, use_energy=use_energy, use_momentum=use_momentum)
